...
def main():
  ...
  plistpath = scriptpath + "/resources/Digilogue-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Digilogue-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Digilogue-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Digilogue-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Digilogue-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Digilogue.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Digilogue.iss",inplace=1):
