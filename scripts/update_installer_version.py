...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Digilogue Demo Installer\n"
      else:
        line="OutputBaseFilename=Digilogue Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Digilogue Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Digilogue installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Digilogue Demo installer\n"
     else:
       line="SetupWindowTitle=Digilogue installer\n"
